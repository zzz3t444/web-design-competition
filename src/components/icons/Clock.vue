<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none" class="dark:text-refine-cyan-alt text-cyan-400">
    <rect width="64" height="64" fill="url(#self-hosted-a)" fill-opacity="0.4" rx="16"></rect>
    <rect width="63" height="63" x="0.5" y="0.5" stroke="url(#self-hosted-b)" stroke-opacity="0.5" rx="15.5"></rect>
    <path
      fill="currentColor"
